...
namespace ZaliantsSurprise.Utils
{
    public class WavUtility
    {
            ...
            string dirname = "recordings")
        {
            ...
            int fileSize = audioClip.samples * BlockSize16Bit + headerSize; // BlockSize (bitDepth)
        ...
        private static int WriteFileData(ref MemoryStream stream, AudioClip audioClip, ushort bitDepth)
        {
            ...
            int subchunk2Size = Convert.ToInt32(audioClip.samples * BlockSize16Bit); // BlockSize (bitDepth)
